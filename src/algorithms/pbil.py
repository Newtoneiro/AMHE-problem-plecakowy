...
class PBIL(AlgorithmBase):
    ...
    def generate_population(self):
        ...
        return (np.random.rand(self.population_size, self.genome_length) < self.probability_vector).astype(int)
    ...
    def update_probability_vector(self, best_individuals):
        ...
        self.probability_vector = (1 - self.learning_rate) * self.probability_vector + self.learning_rate * mean_best
